<%-- 
    Document   : home
    Created on : Mar 4, 2023, 5:28:53 PM
    Author     : son
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%--<link rel="stylesheet" href="user/components/user-style.layout.css">--%>
<title>Header</title>
<header class="header ">
        ...
        <div class="container-header--flex">
            ...
            <div class="wrap-search">
                <form action="#" method="get">
                    <label for=""></label><input type="text" name="" id="" placeholder="Search here">
                </form>
            </div>
            <div class="wrap-action">
                <div class="account">
                    <a href="Info">Accounts</a>
                </div>
                <div class="cart">
                    <a href="#">Cart</a>
                </div>
